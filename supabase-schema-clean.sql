...
DROP VIEW IF EXISTS parcel_dashboard CASCADE;
...
DROP FUNCTION IF EXISTS assign_region_from_postal_code CASCADE;
DROP FUNCTION IF EXISTS set_secret_token CASCADE;
DROP FUNCTION IF EXISTS generate_secret_token CASCADE;
